                                    ...
                                    <div class="recent-comment">
                                        <div class="media">
                                            <div class="media-left">
                                                <a onClick={false}><img alt="..." src="images/avatar/1.jpg" class="media-object"/></a>
                                            </div>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <label>
                                                                ...
                                                                <i class="bg-success"></i><span>Creating component page</span>
                                                                <a href='#' class="ti-close"></a>
                                                            </label>
                                                        </li>
                                                        <li>
                                                            <label>
                                                                <input type="checkbox" checked />
                                                                <i class="bg-warning"></i><span>Follow back those who follow you</span>
                                                                <a href='#' class="ti-close"></a>
                                                            </label>
                                                        </li>
                                                        <li>
